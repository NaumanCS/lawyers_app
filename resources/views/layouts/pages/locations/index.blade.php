            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto text-end">
                        <a href="{{ route('admin.locations.form', $update_id = 0) }}"
