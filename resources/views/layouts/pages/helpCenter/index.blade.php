            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-auto text-end">
                        <a href="{{ route('admin.help.center.form', $update_id = 0) }}"
                                    ...
                                    <tbody>
                                        @foreach ($obj as $key => $val)
                                            <tr>
                                                ...
                                                <td>{{ Illuminate\Support\Str::limit($val->complaint, 30) }}</td>
                                                

                                                
                                                <td class="text-end">
                                                    <a href="{{ route('admin.help.center.form', $val->id) }}"
                                                ...
                                                <td class="text-end">
                                                    <a href="#" class="btn btn-sm bg-success-light delete-location"
                                                        data-url="{{ route('admin.help.center.delete', $val->id) }}">
