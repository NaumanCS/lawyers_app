        ...
        <div class="content">
            <div class="container m-0">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <form action="{{ route('lawyer.documents.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        <div >
                            <div class="row">
                                <div class="col-xl-12">
                                    <h5 class="form-title">Update Documents</h5>
                                </div>
                                
                                <div class="col-xl-4">
                                    <div class="card">
                                        <input type="file" name="high_court_licence" class="dropify"
                                        value="{{ $user->high_court_licence }}" data-default-file="{{ $user->high_court_licence }}">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        value="{{ $user->supreme_court_licence }}" data-default-file="{{ $user->supreme_court_licence }}">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        value="{{ $user->qualification_certificate }}" data-default-file="{{ $user->qualification_certificate }}">
